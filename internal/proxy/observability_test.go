...
func TestDiagnosticsHandlerHTMLAPIAndSecurityHeaders(t *testing.T) {
	...
	for _, expected := range []string{"Signal Room", "Active streams", "Playback stalls", "15m traffic", "Fallback health", "LIVE EDGE ACTIVE", "latest 3 complete segments", "Delivered quality", "Request mix", "Rolling windows", "CDN and upstream hosts", "Stalls", "gRPC trailers", "Recent sanitized errors", "rel=\"icon\" href=\"data:,\"", "scope=\"col\"", "aria-live=\"polite\"", "data-label", "HTTP / upstream", "Result / gRPC", "@media (max-width: 560px)"} {
